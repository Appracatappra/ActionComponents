...
namespace ActionComponents
{
	...
	public class ACDownloadManager
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="ActionComponents.ACDownloadManager"/> aborts
		...
		/// <summary>
		/// Gets a value indicating whether this <see cref="ActionComponents"/> is busy.
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Gets a value indicating whether this <see cref="ActionComponents"/> is suspended.
		/// </summary>
		/// <value>
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="ActionComponents"/> class.
		/// </summary>
		...
		private void Initialize(){
			...
			_client.DownloadFileCompleted+= delegate(object sender, System.ComponentModel.AsyncCompletedEventArgs e) {
				...
				if (e.Error!=null) {
					...
					_downloading.RaiseDownloadCanceled(_downloading.filename);
					...
					_downloading.RaiseDownloadFileCompeted(_downloading.filename);
				}
...
#if TRIAL
				//Check for the trial version of DownloadManager
				if (!PassesTrialLimits(_downloading.URL)) {
					//No, file didn't pass trial test, move on to next file
					if (!abortOnError) DownloadNextFileInQueue();
					return;
				}
#endif
