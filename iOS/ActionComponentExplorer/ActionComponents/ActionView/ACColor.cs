...
{
	/// <summary>
	/// A cross-platform tool for working with colors in the iOS and Android Mobile Operating systems. <c>ACColor</c> 
	/// represents a union of nearly all of the options and features of both <c>UIColor</c> from iOS and the 
	/// <c>Color</c> object from Android so the property or method used on one platform can be used on another
	/// without change in syntax. Several new features are supported such creating a color from or returning a 
	/// color as a CSS/Web Hex String in the form #RRGGBB or #AARRGGBB. <c>ACColor</c> is fully compatible with 
	/// <c>UIColor</c> and <c>Color</c> so it can be used anywhere those objects would be used and can be
	/// cast to and from those types implicitly.  
	/// </summary>
	/// <remarks><c>ACColor</c> includes all of the color presets from iOS and from Android along with a few, custom
	/// "Action" colors.</remarks>
	[Register("ACColor")]
	public class ACColor : NSObject
	{
		...
		{
			get { return UIColor.GroupTableViewBackgroundColor; }
		}
		...
		{
			get { return UIColor.LightTextColor; }
		}
		...
		{
			get { return UIColor.ScrollViewTexturedBackgroundColor; }
		}
		...
		{
			get { return UIColor.UnderPageBackgroundColor; }
		}
		...
		{
			get { return UIColor.ViewFlipsideBackgroundColor; }
		}
		...
		{
			return UIColor.FromRGB(value, value, value);
		}
		...
		{
			return UIColor.FromRGB(red, blue, green);
		}
		...
		/// <param name="green">Green.</param>
		/// <param name="blue">Blue.</param>
		public static ACColor FromRGB(nfloat red, nfloat green, nfloat blue)
		{
			return UIColor.FromRGB(red, green, blue);
		}
		...
		/// <param name="blue">Blue.</param>
		/// <param name="alpha">Alpha.</param>
		public static ACColor FromRGBA(nfloat red, nfloat green, nfloat blue, nfloat alpha)
		{
			return UIColor.FromRGBA(red, green, blue, alpha);
		}
		...
		/// <param name="saturation">Saturation.</param>
		/// <param name="brightness">Brightness.</param>
		public static ACColor FromHSB(nfloat hue, nfloat saturation, nfloat brightness)
		{
			//Return color
			return UIColor.FromHSB(hue, saturation, brightness);
		}
		...
		{
			//Return color
			return UIColor.FromHSBA(hue, saturation, brightness, alpha);
		}
		...
		/// <param name="brightness">Brightness.</param>
		/// <param name="alpha">Alpha.</param>
		public static ACColor FromHSBA(nfloat hue, nfloat saturation, nfloat brightness, nfloat alpha)
		{
			//Return color
			return UIColor.FromHSBA(hue, saturation, brightness, alpha);
		}
		...
		{
			return UIColor.FromWhiteAlpha(grayscale, alpha);
		}
		...
		/// <param name="grayscale">Grayscale.</param>
		/// <param name="alpha">Alpha.</param>
		public static ACColor FromWhiteAlpha(nfloat grayscale, nfloat alpha)
		{
			return UIColor.FromWhiteAlpha(grayscale, alpha);
		}

		/// <summary>
		/// Creates a UIColor from a CoreGraphics CGColor.
		/// </summary>
		/// <returns>The CG color.</returns>
		/// <param name="color">Color.</param>
		public static ACColor FromCGColor(CGColor color)
		{
		...
		/// </summary>
		/// <returns>The CI color.</returns>
		/// <param name="color">Color.</param>
		public static ACColor FromCIColor(CIColor color)
		{
			return UIColor.FromCIColor(color);
		}
		...
		/// <summary>
		/// Gets the <c>CGColor</c> for this <c>ACColor</c> 
		/// </summary>
		/// <value>The color of the cg.</value>
		public CGColor CGColor
		{
			get { return _color.CGColor; }
		}
		...
		public byte A
		{
			...
			set
			{
				...
				//Create a new color with the 
				_color = new UIColor(red, green, blue, value);
			}
		}
		...
		public byte R
		{
			...
			set
			{
				...
				//Create a new color with the 
				_color = new UIColor(value, green, blue, alpha);
			}
		}
		...
		public byte G
		{
			...
			set
			{
				...
				//Create a new color with the 
				_color = new UIColor(red, value, blue, alpha);
			}
		}
		...
		public byte B
		{
			...
			set
			{
				...
				//Create a new color with the 
				_color = new UIColor(red, green, value, alpha);
			}
		}
		#endregion
		...
		/// <summary>
		/// Converts a <c>ACColor</c> to an iOS <c>UIColor</c>
		/// </summary>
		/// <param name="color">Color.</param>
		public static implicit operator UIColor(ACColor color)
		{
			return color.ToUIColor();
		}

		/// <summary>
		/// Converts an iOS <c>UIColor</c> to a <c>ACColor</c> 
		/// </summary>
		/// <param name="color">Color.</param>
		public static implicit operator ACColor(UIColor color)
		{
			//Break color into pieces
			nfloat red = 0, green = 0, blue = 0, alpha = 0;
			color.GetRGBA(out red, out green, out blue, out alpha);

			return new ACColor(red, green, blue, alpha);
		}
		#endregion
		...
		{
			_color = UIColorFromHexString(hexValue);
		}
		...
		{
			//Set default color
			_color = UIColor.FromRGB(red, green, blue);
		}
		...
		{
			//Set default color
			_color = UIColor.FromRGBA(red, green, blue, alpha);
		}
		...
		/// <param name="alpha">Alpha.</param>
		/// <remarks>iOS <c>UIColor</c> style constructor</remarks>
		public ACColor(nfloat red, nfloat green, nfloat blue, nfloat alpha)
		{
			//Set default color
			_color = UIColor.FromRGBA(red, green, blue, alpha);
		}
		...
		/// <summary>
		/// Converts the given CSS/Web style color specification to a given UIColor specification
		/// </summary>
		/// <returns>The color from hex string.</returns>
		/// <param name="hexValue">Hex value.</param>
		public UIColor UIColorFromHexString(string hexValue)
		{
			var colorString = hexValue.Replace("#", "");
		...
		/// <summary>
		/// Converts the <c>ACColor</c> to a default iOS <c>UIColor</c> and returns it
		/// </summary>
		...
		public nfloat GetBrightness()
		{
			nfloat hue = 0, saturation = 0, brightness = 0, alpha = 0;
			_color.GetHSBA(out hue, out saturation, out brightness, out alpha);
		...
		public string ToHexString(bool withAlpha)
		{
			...
			if (withAlpha)
			{
				return String.Format("#{0:X2}{1:X2}{2:X2}{2:X2}", alpha, red, green, blue);
			}
			else
			{
		...
		/// <param name="alpha">Alpha.</param>
		public ACColor ColorWithAlpha(nfloat alpha)
		{
			//Return adjust color
			return _color.ColorWithAlpha(alpha);
		}
		...
		/// <param name="brightness">Brightness.</param>
		/// <param name="alpha">Alpha.</param>
		public void GetHSBA(ref nfloat hue, ref nfloat saturation, ref nfloat brightness, ref nfloat alpha)
		{
		...
		/// <param name="blue">Blue.</param>
		/// <param name="alpha">Alpha.</param>
		public void GetRGBA(ref nfloat red, ref nfloat green, ref nfloat blue, ref nfloat alpha)
		{
			//Grab requested values
			_color.GetRGBA(out red, out green, out blue, out alpha);
		}
