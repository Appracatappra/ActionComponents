...
namespace ActionComponents
{
	...
	public class ACAlertDragConstraint
	{
		#region Private Variables
		private ACAlertDragConstraintType _constraintType;
		private nfloat _minimumValue;
		private nfloat _maximumValue;
		#endregion 
		...
		public ACAlertDragConstraintType constraintType{
		...
		/// </summary>
		public ACAlertDragConstraint () {
			this._constraintType=ACAlertDragConstraintType.None;
		...
		public ACAlertDragConstraint(ACAlertDragConstraintType constraint, nfloat minimum, nfloat maximum) {
