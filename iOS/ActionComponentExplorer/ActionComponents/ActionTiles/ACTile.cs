...
namespace ActionComponents
{
	...
	public class ACTile : UIView
	{
		...
		public void DrawScene(CGRect rect) {
			...
			// Calculate text size
			nfloat titleHeight = ACFont.StringSize(title, UIFont.SystemFontOfSize(appearance.titleSize), new CGSize(rect.Width - (x + 10f), rect.Height), UILineBreakMode.TailTruncation).Height;
		...
		public void DrawAccessory(CGRect rect)
		{
			...
			// Calculate text size
			nfloat titleHeight = ACFont.StringSize(subtitle, UIFont.SystemFontOfSize(appearance.subtitleSize), new CGSize(rect.Width - 20f, 50f), UILineBreakMode.TailTruncation).Height;

			//// title Drawing
			var titleRect = new CGRect(10f, rect.Height - (titleHeight + 10f), rect.Width - 20f, titleHeight);
			appearance.subtitleColor.SetFill();
			new NSString(subtitle).DrawString(titleRect, UIFont.SystemFontOfSize(appearance.subtitleSize), UILineBreakMode.TailTruncation, UITextAlignment.Left);

			// Calculate text size
			titleHeight = ACFont.StringSize(title, UIFont.BoldSystemFontOfSize(appearance.titleSize), new CGSize(rect.Width - 20f, rect.Height - (titleHeight + 50f)), UILineBreakMode.TailTruncation).Height;
		...
		public void DrawTopTitleBar(CGRect rect, bool withIcon){
			nfloat titleHeight = ACFont.StringSize (title, UIFont.BoldSystemFontOfSize (appearance.titleSize), new CGSize (rect.Width , 50f), UILineBreakMode.TailTruncation).Height+3;
			...
			if (subtitle != "" && !withIcon) {
				nfloat subtitleHeight = ACFont.StringSize (subtitle, UIFont.BoldSystemFontOfSize (appearance.subtitleSize), new CGSize (rect.Width , 50f), UILineBreakMode.TailTruncation).Height+3;
		...
		private void DrawDescriptionBlock(CGRect rect) {
			...
			if (subtitle != "" && tileSize != ACTileSize.Single) {
				subtitleHeight = ACFont.StringSize (subtitle, UIFont.BoldSystemFontOfSize (appearance.subtitleSize), new CGSize (rect.Width , 50f), UILineBreakMode.TailTruncation).Height+3;
